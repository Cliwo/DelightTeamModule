package org.androidtown.delightteammodule.MATCH.Waiting;
...
public class FragMatchWaiting extends Fragment {

    RecyclerView recyclerView;
    RecyclerAdapter<MatchCardView, MatchCardData> recyclerAdapter;


    public FragMatchWaiting() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_frag_match_waiting, container, false);
        ...
        recyclerAdapter = new RecyclerAdapter<MatchCardView, MatchCardData>(R.layout.item_match_card, new CustomViewFactory<MatchCardView>() {
            ...
            public MatchCardView createViewHolder(View layout, ViewGroup parent) {
                ...
                final MatchCardView matchCardView = new MatchCardView(view, MatchDataBase.MATCH_WAITING);
    ...
    public void setRecyclerViewWithData()
    {
        ...
        {
            if(data.baseData.matchState== MatchDataBase.MATCH_WAITING)
